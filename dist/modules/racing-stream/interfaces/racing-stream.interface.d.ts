...
export interface RoomServiceInterface {
    ...
    joinRoom(roomId: string, userId: string, username: string, socketId: string): RaceRoom | null;
    ...
    removeParticipant(roomId: string, userId: string, isAdminAction?: boolean): RaceRoom | null;
    getAdminStats(): {
        totalRooms: number;
